...
<form action="{{ isset($data)
  ?route('pemesanan.update',["id" => $data->id])
  :route('pemesanan.simpan') }}" method="POST">
  @csrf
...
<tr>
    ...
    <td>{{ $item->kodebus }}</td>
    <td><a href="{{ route('pemesanan.tampil',["id" => $item->id]) }}"
      class="btn btn-warning btn-block">Rubah</a></td>
    <td><a href="{{ route('pemesanan.hapus',["id" => $item->id]) }}"
